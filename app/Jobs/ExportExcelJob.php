...
class ExportExcelJob implements ShouldQueue
{
    ...
    private function generateEmailBody(?array $data): string
    {
        ...
        $body .= $data
            ? ' Vedlagt ligger et midlertidig lønnsskjema med en beregnet lønnsplassering.<br/><br/>DETTE ER IKKE EN ENDELIG LØNNSPLASSERING. Den er maskinberegnet og kan resultere i avvik (1-2 lønnstrinn).<br/><br/>For en endelig lønnsplassering må du: <ul><li>åpne vedlegget i denne eposten</li><li>fylle ut personalia og eventuelt delen medfrivillige verv</li><li>sendes skjemaet til hr@frikirken.no for beslutning av lønnsplasseringen</li></ul>'

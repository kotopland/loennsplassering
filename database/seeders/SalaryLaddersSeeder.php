...
class SalaryLaddersSeeder extends Seeder
{
    public function run()
    {
        DB::table('salary_ladders')->select('id')->delete();
        $salaryLadders = [
            'A' => [
        ...
        foreach ($salaryLadders as $ladder => $groups) {
            foreach ($groups as $group => $salaries) {
                SalaryLadder::create([
                    'ladder' => $ladder,
                    'group' => $group,
                    'salaries' => $salaries,

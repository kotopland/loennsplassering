                                            ...
                                            <div class="row g-3 my-2 border border-primary border-2 bg-info p-2 p-md-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 col-md-4 my-3">
                                                        ...
                                                        <input type="number" id="study_points_entry" name="study_points_entry" @if (old('study_points', $item['study_points']) == 'bestått') disabled @endif value="@if (old('study_points') != 'bestått') {{ old('study_points', $item['study_points']) }} @endif" min="0" max="800" class="form-control @error('study_points') is-invalid @enderror" placeholder="@if (old('study_points', $item['study_points']) == 'bestått') bestått @else Antall studiepoeng i tall. Eks 180 @endif" _="on keyup set #register_study_points.value to #study_points_entry.value">
                                                        @error('study_points')
                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                        @enderror
                                                        <div class="form-check form-switch my-2">
                                                            <input class="form-check-input" type="checkbox" role="switch" @if (old('study_points', $item['study_points']) == 'bestått') checked @endif id="register_studiepoeng" _="on change if my.checked then add @@disabled to #study_points_entry then set #register_study_points.value to 'bestått' then set #study_points_entry.placeholder to 'bestått' then set #study_points_entry.value to '' else remove @@disabled from #study_points_entry then set #register_study_points.value to #study_points_entry.value then set #study_points_entry.placeholder to 'Antall studiepoeng i tall. Eks 180' end">
                ...
                <form action=" {{ route('post-education-information') }}" method="POST" id="salary_form">
                    ...
                    <div class="row g-3 mb-2 border border-primary border-2 bg-success-subtle p-2 p-md-4">
                        ...
                        <div class="col-4 col-md-4">
                            ...
                            <label for="update_start_date" class="form-check-label">Studiepoeng</label>
                            <input type="number" id="study_points_entry" name="study_points_entry" value="@if (old('study_points') != 'bestått') {{ old('study_points') }} @endif" min="1" max="800" @if (old('study_points') == 'bestått') disabled @endif class="form-control @error('study_points') is-invalid @enderror" placeholder="@if (old('study_points') == 'bestått') bestått @else Antall studiepoeng i tall. Eks 180 @endif" _="on keyup set #register_study_points.value to #study_points_entry.value">
                            @error('study_points')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            <div class="form-check form-switch px-1 my-2">
                                <input class="form-check-input" type="checkbox" role="switch" @if (old('study_points') == 'bestått') checked @endif id="register_studiepoeng" _="on change if my.checked then add @@disabled to #study_points_entry then set #register_study_points.value to 'bestått' then set #study_points_entry.placeholder to 'bestått' then set #study_points_entry.value to '' else remove @@disabled from #study_points_entry then set #register_study_points.value to #study_points_entry.value then set #study_points_entry.placeholder to 'Antall studiepoeng i tall. Eks 180' end">
                                <label for="register_studiepoeng" class="form-check-label">
                                    Ikke studiepoeng/bestått
                                </label>
                            </div>

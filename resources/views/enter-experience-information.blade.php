                                                        ...
                                                        <div class="row p-2">
                                                            <div class="col-auto p-2 pe-4">
                                                                <div class="form-check form-switch px-1 my-2">
                                                                    <input type="checkbox" id="update_relevance" name="relevance" role="switch" value="true" class="form-check-input" @if (old('relevance', $item['relevance'] ?? '') == 'true') checked @endif>

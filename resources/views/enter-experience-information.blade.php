        ...
        <div>
            <table class="table table-sm w-100">
                ...
                <tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-md-3">
                                            <label for="update_title_workplace" class="form-check-label">Tittel og
                                                arbeidssted:</label>
                                            <input type="text" id="update_title_workplace" name="title_workplace"
                                                value="{{ old('title_workplace', $item['title_workplace']) }}"
                                                class="form-control @error('title_workplace') is-invalid @enderror"
                                                placeholder="Skriv inn tittel og arbeidssted">
                                        ...
                                        <!-- Work Percentage -->
                                        <div class="col-6 col-md-3">
                                            <label for="update_percentage"
                                                class="form-check-label">Stillingsprosent:</label>
                                            <input type="number" id="update_percentage" name="percentage" min="0"
                                                max="100" value="{{ old('percentage', $item['percentage']) }}" required
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-6 ">
                                                    ...
                                                    <input type="date" id="update_end_date" name="end_date"
                                                        min="1950-01-01"
                                                        max="{{ \Carbon\Carbon::parse($application->work_start_date)->subDay() }}"
                                                        value="{{ old('end_date', $item['end_date']) }}"
                                                        class="form-control @error('end_date') is-invalid @enderror"
                                                        aria-describedby="endDateHelpBlock" style="max-width: 150px">
                                        ...
                                        <div class="row p-2">
                                            <div class="col-auto p-2 pe-4">
                                                <input type="radio" id="update_normal" name="workplace_type" value=""
                                                    class="form-check-input @error('workplace_type') is-invalid @enderror"
                                                    @if(old('workplace_type', $item['workplace_type'] ?? '' )==='' )
                                                    checked @endif>
                                            ...
                                            <div class="col-auto p-2 pe-4">
                                                <input type="radio" id="update_freechurch" name="workplace_type"
                                                    value="freechurch"
                                                    class="form-check-input @error('workplace_type') is-invalid @enderror"
                                                    @if(old('workplace_type', $item['workplace_type'] ?? ''
                                                    )==='freechurch' ) checked @endif>
                                                <label for="update_freechurch"
                                                    class="form-check-label">Frikirken</label>
                                            </div>

                                            <div class="col-auto p-2 pe-4">
                                                <input type="radio" id="update_other_christian" name="workplace_type"
                                                    value="other_christian"
                                                    class="form-check-input @error('workplace_type') is-invalid @enderror"
                                                    @if(old('workplace_type', $item['workplace_type'] ?? ''
                                                    )==='other_christian' ) checked @endif>
                                            ...
                                            <div class="col-auto p-2 pe-4">
                                                <input type="radio" id="update_elder" name="workplace_type"
                                                    value="elder"
                                                    class="form-check-input @error('workplace_type') is-invalid @enderror"
                                                    @if(old('workplace_type', $item['workplace_type'] ?? '' )==='elder'
                                                    ) checked @endif>
                                        ...
                                        <div class="row p-2">
                                            <div class="col-auto p-2 pe-4">
                                                <input type="submit" id="update-btn-submit" name="submit"
                                                    value="Oppdater erfaring"
                                                    class="btn btn-primary me-2 @if(null === old('title_workplace', $item['title_workplace'])) disabled @endif">
                                                <a href="{{ route('enter-experience-information') }}"
                    ...
                    <tr>
                        <th id="title_workplace-{{ $id }}" scope="row">{{ strlen($item['title_workplace']) > 30 ?
                            substr($item['title_workplace'], 0, 30) . '...' : $item['title_workplace'] }}</th>
                        ...
                        <td>
                            <a class="btn btn-sm @if(in_array(null, [@$item['title_workplace'], @$item['percentage'] == '' ? null : '', @$item['start_date'] == '' ? null : '', @$item['end_date'] == '' ? null : '', @$item['relevance']], true)) btn-danger @else btn-outline-primary @endif"
                                href="{{ route('enter-experience-information', [$application, 'edit' => $id]) }}#update">
                                @if(in_array(null, [@$item['title_workplace'], @$item['percentage'] == '' ? null : '',
                        ...
                        <td><a class="btn btn-sm btn-outline-danger" href={{ route('destroy-experience-information',
                                ['id'=> $id]) }}>Slett linje</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
                ...
                <div class="row g-3 mb-2 border border-primary border-2 bg-success-subtle p-2 p-md-4">
                    ...
                    <div class="row">
                        <div class="col-auto">
                            ...
                            <input type="text" id="title_workplace" name="title_workplace"
                                value="{{ old('title_workplace') }}" placeholder=""
                        ...
                        <div class="col-auto pe-4">
                            ...
                            <input type="number" min="0" max="100" required id="percentage" name="percentage"
                                value="{{ old('percentage') }}" placeholder="%"
                                class="form-control @error('percentage') is-invalid @enderror">
                        </div>
                        <div class="col-auto">
                            <div class="row justify-content-center">
                                <div class="col-auto pe-4">
                                    ...
                                    <input type="date" id="start_date" name="start_date" min="1950-01-01"
                                ...
                                <div class="col-auto pe-4">
                                    ...
                                    <input type="date" id="end_date" name="end_date" min="1950-01-01"
                                        value="{{ old('end_date') }}"
                                        max="{{ \Carbon\Carbon::parse($application->work_start_date)->subDay() }}"
                                        value="{{ old('end_date') }}"
                                        class="form-control @error('end_date') is-invalid @enderror"
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-auto p-2  pe-4">
                            <input type="radio" class="form-check-input @error('workplace_type') is-invalid @enderror"
                                id="normal" name="workplace_type" @if(!old('workplace_type')) checked @endif value="">
                            <label class="form-check-label" for="normal">Ikke kristen organisasjon/kirke</label>
                        </div>
                        <div class="col-auto p-2  pe-4">
                            <input type="radio" class="form-check-input @error('workplace_type') is-invalid @enderror"
                                id="freechurch" name="workplace_type" value="freechurch"
                                @if(old('workplace_type')==='freechurch' ) checked @endif>
                            <label class="form-check-label" for="freechurch">Frikirken</label>
                        </div>
                        <div class="col-auto p-2  pe-4">
                            <input type="radio" class="form-check-input @error('workplace_type') is-invalid @enderror"
                                id="other_christian" name="workplace_type" value="other_christian"
                                @if(old('workplace_type')==='other_christian' ) checked @endif>
                            <label class="form-check-label" for="other_christian">Annen kristen
                                organisasjon/kirke</label>
                        </div>
                        <div class="col-auto p-2  pe-4">
                            <input type="radio" class="form-check-input @error('workplace_type') is-invalid @enderror"
                                id="elder" name="workplace_type" value="elder" @if(old('workplace_type')==='elder' )
                                checked @endif>
...
<div class="text-md-end text-center pb-1">
    ...
    @if($hasErrors)
    <a href="{{ route('enter-courses-and-activity-information', $application) }}" class="btn btn-primary my-2 disabled"
        id="btn-next">
        Neste: Kurs og Verv
    </a>
    <span class="badge text-bg-danger">Du må oppdatere felt med mangler før du kan gå videre</span>
    @else
    <a href="{{ route('enter-courses-and-activity-information', $application) }}" class="btn btn-primary my-2"
        id="btn-next">
        Neste: Kurs og Verv
    </a>
    @endif

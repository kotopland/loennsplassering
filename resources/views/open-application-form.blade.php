...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Åpne et lagret lønnsskjema</div>

                    <div class="card-body">
                        <p>For å åpne lønnsskjemaet, vennligst bekreft din identitet ved å oppgi din fødselsdato og postnummer.</p>
                        ...
                        <form method="POST" action="{{ route('open-application', $application) }}">
                            @csrf

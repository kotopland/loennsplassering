...
@section('content')
    <div class="container">
        ...
        <div class="my-2 py-3">
            ...
            <p>
                <a href="#" class="btn btn-sm btn-success" _="on click remove .d-none from #beregning then wait 200ms then go to #beregning @if (!$application->email_sent) then confirm('Ikke glem å trykke på knappen \'Send inn til Frikirkens hovedkontor for behandling\' etter at du har sett på den beregnede plasseringen') @endif">
        ...
        <div class="my-4 text-end">
            @if (!$application->isReadOnly())
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#submitToOfficeModal">
                    Fyll ut Personalia og Send inn for behandling
                </button>
            @else
                <a href={{ route('enter-employment-information', $application) }} class="btn btn-outline-primary">
                    Gå tilbake
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="submitToOfficeModalLabel">Fyll ut Personalia og Send inn for behandling</h1>
